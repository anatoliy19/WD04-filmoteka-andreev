...
if ( array_key_exists('update-movie', $_POST) ) {
	...
	// Обработка ошибок
	if ( $_POST['name'] == '') {
		$errors[] = "<p>Надо ввести название фильма!</p>";
	}
	if ( $_POST['kind'] == '') {
		$errors[] = "<p>Надо ввести жанр фильма!</p>";
	}
	if ( $_POST['year'] == '') {
		$errors[] = "<p>Надо ввести год фильма!</p>";
	}
...
<!--[if lt IE 9]>
  ...
  <body>
	...
	<h1 class="title-1">Фильм <?=$movie['name']?></h1>
	  ...
	  <div class="panel-holder mt-0 mb-20">
		...
		<form action="edit.php?id=<?=$movie['id']?>" method="POST">
			...
			<input 	class="input" type="text" 
					placeholder="Название фильма" name="name" 
					value="<?=$movie['name']?>" />

			<div class="row">
				<div class="col">
					<label class="label-title">Жанр</label>
					<input 	class="input" type="text" placeholder="Жанр" name="kind" 
							value="<?=$movie['kind']?>" />
				</div>
				<div class="col">
			...
			<input type="submit" class="button" value="Обновить информацию" name="update-movie">
		</form>
	  </div>
	 	<div class="mb-100">
